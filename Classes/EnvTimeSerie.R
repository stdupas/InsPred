...
setMethod("ToStream", "EnvTimeSerie",
          function(object){
...
EnvTimeSerie <- function(x=list(matrix(NA),as.Date(1))) 
{
  if (!(class(x)%in%c("list","RasterStackTS","character"))) stop("wrong arguments")
